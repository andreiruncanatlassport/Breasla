    ...
    <>
      ...
      <div className="mesh-hero relative overflow-hidden border-b border-line">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-8 pt-12">
          <p className="stamp-label text-seal">Registrul breslei</p>
          <h1 className="mt-2 text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
            Catalog firme
          </h1>
          <p className="mt-2 text-sm text-ink-soft">
            <span className="font-mono-num font-semibold text-ink">{cards.length}</span> firme
            verificate prin ANAF
            {params.locatie && " · sortate după distanță"}
          </p>
      ...
      <div className="mx-auto max-w-6xl px-5 py-10">
        ...
        {!error && cards.length === 0 && (
          <div className="block-inset flex flex-col items-center py-16 text-center">
            ...
            <p className="mt-4 font-semibold text-ink">Nicio firmă găsită</p>
            <p className="mt-1 max-w-sm text-sm text-ink-soft">
              Încearcă să lărgești căutarea — mai puține filtre, sau o rază geografică mai mare.
            </p>
          </div>
        )}
