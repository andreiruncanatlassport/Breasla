  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-12">
      <div className="max-w-xl">
        <p className="stamp-label text-seal">Directorul comunității</p>
        ...
        <p className="mt-3 text-base text-ink-soft">
          Antreprenori și profesioniști din comunitatea Rețelei Antreprenorilor Creștini. Trimite un mesaj direct oricui.
        </p>
      </div>
      ...
      <form className="mt-8 max-w-sm">
        <input
          ...
          name="q"
          defaultValue={q}
          placeholder="Caută după nume, firmă sau titlu..."
      ...
      {membri.length === 0 ? (
        <p className="mt-10 text-sm text-ink-soft">
          {q ? "Niciun membru găsit pentru această căutare." : "Niciun membru public momentan."}
        </p>
      ) : (
