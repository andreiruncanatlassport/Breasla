  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-12">
      <div className="max-w-xl">
        ...
        <p className="mt-3 text-base text-ink-soft">Articole, interviuri și noutăți din comunitatea Rețelei Antreprenorilor Creștini.</p>
      </div>

      {stiri.length === 0 ? (
        <p className="mt-10 text-sm text-ink-soft">Nicio știre publicată momentan.</p>
      ) : (
