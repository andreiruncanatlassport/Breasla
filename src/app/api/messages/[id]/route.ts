...
/** Șterge conversația din lista mea (elimin doar participarea mea — celălalt
 * o păstrează pe a lui). Dacă rămân zero participanți, mesajele rămân orfane
 * dar inaccesibile (nimeni nu mai are RLS pentru ele). */
